...
- readme.txt is permanently removed. NEVER create, regenerate, prompt for, or suggest this file.
Root readme.md hero block: NO `img.shields.io/badge/…-…-<color>` static mockup badges, NO `activate`/`no status`/`not found`/`404` placeholders. See `mem://constraints/no-static-mockup-badges`.
...
- [Reorganization audit 2026-04-22](spec/validation-reports/2026-04-22-reorganization-audit.md) — Final health report (94/100 A); permanent migration record at `spec/99-archive/governance-history/2026-04-22-reorganization-plan.md`.
...
- [Root README conventions](mem://standards/root-readme-conventions) — Centered icon-led title, 5 group markers (per-group floors ≥1/≥1/≥0/≥1/≥1, total ≥5), Author + Company sections, single H1, NO static mockup badges (post-amendment 2026-04-22)
- [Root README read/write spec](spec/01-spec-authoring-guide/12-root-readme-read-write-spec.md) — Canonical read → edit → validate procedure for readme.md (tooling preference, hero-block invariants, handoff checklist)
- [No static mockup badges](mem://constraints/no-static-mockup-badges) — Forbids `img.shields.io/badge/…` static badges and all `activate`/`no status`/`not found`/`404` placeholders in the readme.md hero
