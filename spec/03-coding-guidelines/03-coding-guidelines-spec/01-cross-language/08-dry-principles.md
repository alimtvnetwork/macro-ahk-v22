...
- [Response Envelope Schema](../../../03-error-manage-spec/04-error-manage-spec/02-error-architecture/05-response-envelope/envelope.schema.json) — Cross-stack type contract
