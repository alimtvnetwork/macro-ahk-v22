...
- [Error Management Spec](../../03-error-manage-spec/04-error-manage-spec/00-overview.md)
- [Consolidation Plan](../../../.lovable/memories/done/coding-guidelines-consolidation-plan.md)
