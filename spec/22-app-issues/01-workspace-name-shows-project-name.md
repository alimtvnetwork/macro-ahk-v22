...
1. Created `/spec/10-macro-controller/workspace-detection.md` with explicit rules for workspace name detection.
...
- `/spec/10-macro-controller/workspace-detection.md` — "Critical Rule: DOM-Discovered Names Must Be Validated"
- `/spec/10-macro-controller/workspace-detection.md` — "Known Pitfalls and Prevention" table
...
- [x] Spec updated under `/spec/10-macro-controller/workspace-detection.md`
- [x] Issue write-up created under `/spec/17-app-issues/01-workspace-name-shows-project-name.md`
